...
TOKEN = ("7252693653:AAG1SAvrYjJX2qAQs8xbhk4SE5GUyc7ppwk")
...
SUDO_USERS = ['6070918315' ""]  



BOT_OWNER_ID = '6070918315'   
...
CHANNEL_ID = -1002238993005
CHANNEL_LINK = "https://t.me/sexgrilss"
GROUP_ID = -1002028970832
GROUP_LINK = "https://t.me/destekbo"
chat_id_destek = -1002028970832
yasakli_kelimeler = {"yaram"}
...
premium_user_ids = [6070918315] 



required_channels = ["-1002238993005", "-1002028970832"]
...
""",
    "🍀 Ücretsiz Api": """
BurcAPİ
https://tsgchecker.tsgmods.com.tr/yunus/burc.php?tc=11111111110
tc Api
https://tsgchecker.tsgmods.com.tr/yunus/tc.php?tc=11111111110
Aile Api:
https://tsgchecker.tsgmods.com.tr/yunus/aile.php?tc=11111111110
Sulale Api:
https://tsgchecker.tsgmods.com.tr/yunus/sulale.php?tc=11111111110
Tc GSM Api:
https://tsgchecker.tsgmods.com.tr/yunus/tcgsm.php?tc=11111111110
GSM tc Api:
https://tsgchecker.tsgmods.com.tr/yunus/gsmtc.php?gsm=5555555555
Tcpro Api:
https://tsgchecker.tsgmods.com.tr/yunus/tcpro.php?auth=tsgxyunus&tc=11111111110
IBAN Api;
https://tsgchecker.tsgmods.com.tr/yunus/iban.php?iban=
Kizlik Api:
https://tsgchecker.tsgmods.com.tr/yunus/kizlik.php?tc=11111111110
Operatör Api:
https://tsgchecker.tsgmods.com.tr/yunus/operator.php?gsm=5555555555
Serino Api:
https://tsgchecker.tsgmods.com.tr/yunus/serino.php?tc=11111111110
Sicil Api:
https://tsgchecker.tsgmods.com.tr/yunus/sicil.php?tc=11111111110
SMS bomber Api:
https://tsgchecker.tsgmods.com.tr/yunus/sms.php?telno=5555555555
Ayak Api:
https://tsgchecker.tsgmods.com.tr/yunus/ayak.php?tc=11111111110
Yarrak Ve Boy Sorgu Api:
https://tsgchecker.tsgmods.com.tr/yunus/cmboy.php?tc=11111111110
İhbar Api:
https://tsgchecker.tsgmods.com.tr/yunus/ihbar.php?ad=ali&soyad=celik&olayyeri=istanbul&il=istanbul&telno=5535535353&ilce=beylikduzu&konu=bicaklama&beyan=saygilarla
İp Sorgu Api:
https://tsgchecker.tsgmods.com.tr/yunus/ip.php?ip=8.8.8.8
Anne Baba Sorgu Api:
https://tsgchecker.tsgmods.com.tr/yunus/annebaba.php?tc=11111111110
Çocuk Sorgu APİ:
https://tsgchecker.tsgmods.com.tr/yunus/cocuk.php?tc=11111111110
Kardes Sorgu Api:
https://tsgchecker.tsgmods.com.tr/yunus/kardes.php?tc=11111111110
Kuzen Sorgu Api:
https://tsgchecker.tsgmods.com.tr/yunus/kuzen.php?tc=11111111110
Yeğen Sorgu:
https://tsgchecker.tsgmods.com.tr/yunus/yegen.php?tc=11111111110
Full Sorgu:
https://tsgchecker.tsgmods.com.tr/yunus/full.php?tc=11111111110
Ad SOYAD:
https://tsgchecker.tsgmods.com.tr/yunus/adsoyad.php?ad=Ali&soyad=Kaya
Ad SOYAD İl:
https://tsgchecker.tsgmods.com.tr/yunus/adsoyadil.php?ad=Ali&soyad=Kaya&il=Mardin
Ad Soyad İl İlce
https://tsgchecker.tsgmods.com.tr/yunus/adsoyadililce.php?ad=Ali&soyad=Kaya&il=Mardin&ilce=artuklu

Adres 
https://tsgchecker.tsgmods.com.tr/yunus/adres.php?tc=11111111110
...
def start(message):
    ...
    item1 = types.InlineKeyboardButton("Komutlar", callback_data='komutlar')
    item2 = types.InlineKeyboardButton("Hakkımızda", callback_data='hakkimizda')
    markup.add(item1, item2)
    bot.send_message(message.chat.id, "Merhaba! 👋 Hoş geldiniz. Aşağıdaki menüden bir seçenek seçebilirsiniz:", reply_markup=markup)
...
def callback_query(call):
    ...
    if call.data == "komutlar":
        if check_subscription(call.from_user.id):
            ...
            bot.send_message(call.message.chat.id, "Komutlar kısmını açabilmek için @sexgrilss ve @destekbo kanallarına katılmanız gerekmektedir.")
        ...
        bot.edit_message_text(chat_id=call.message.chat.id,
                              message_id=call.message.message_id,
                              text="Kanalımıza Katılmayı Unutmayın. @sexgrilss",
...
AUTHORIZED_USER_IDS = [6070918315]  # Gerçek kullanıcı kimlikleri ile değiştirin
...
def handle_ara(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "Lütfen komutu şu şekilde kullanın: /ara [arama terimi] (örneğin: /ara youtube.com)")
...
def sohbet_cevap_gonder(message):
    ...
    if "benim babam utiricdir lan (birde **nochad.dev**)" in text.lower():
        bot.send_message(message.chat.id, "Benim Babam @sexgrilss dir.")
    else:
...
def metni_sese_donustur(message):
    ...
    if any(kelime in metin for kelime in filtreli_kelimeler):
        ...
        url = f"https://t.me/sexgrilss"
        button = types.InlineKeyboardButton(text="Ses Depolama Kanalına Katıl", url=url)
        keyboard.add(button)
        ...
        log_chat_id = -1002028970832  # Log grubunun ID'sini buraya yazın
...
def process_tiktok_link(message, url):
    try:
        if validate_tiktok_link(url):
            ...
            bot.send_video(message.chat.id, video_info['link'], caption="- Video Başarıyla İndirildi @RetroModsChat.")
        else:
            bot.reply_to(message, "Geçersiz TikTok video linki. Lütfen doğru bir TikTok video linki girin. Örnek/n /tiktok https://vm.tiktok.com/")
...
def tcplus_sorgula(message):
    ...
    bot.send_message(-1002028970832, log_message)

    channel_id = 1002028970832
    group_id = 1002028970832
    ...
    if not is_user_member(user_id, channel_id) or not is_user_member(user_id, group_id):
        response = (f"Merhaba {user_name}, ({user_id})!\n\n"
                    ...
                    f"Kanal: https://t.me/sexgrilss\nChat: https://t.me/destekbo")
...
def log_sorgu(user_name, ad, soyad, il):
    ...
    log_channel_id = "-1002028970832"  # Log kanalının ID'si
...
def handle_messages(message):
    if 'Ahmet' in message.text.lower():
        bot.reply_to(message, "Evet, Benim Yapımcım: @zirvebenimyerim")
    else:
    ...
    if results and len(results) > 0:
        ...
        try:
            ...
            if audio_stream:
                ...
                channel_username = "RetroArsivq"  # Kanalın kullanıcı adını buraya yaz
                join_channel_text = "Müziklerin Kanalı"
                join_channel_link = f"https://t.me/{channel_username}"
                keyboard = types.InlineKeyboardMarkup()
                url_button = types.InlineKeyboardButton(text=join_channel_text, url=join_channel_link)
                keyboard.add(url_button)
...
def handle_mute(message):
    ...
    """
    try:
        # Sadece kanal yöneticilerinin kullanabilmesini sağla
        chat_member = bot.get_chat_member(message.chat.id, message.from_user.id)
        if chat_member.status in ("administrator", "creator"):
            # Yanıtlanan mesajı bul
            reply_to = message.reply_to_message
            if reply_to is not None:
                # Yanıtlanan mesajın gönderenini sustur
                mute_yapilacak_kullanici_id = reply_to.from_user.id
                ...
                bot.send_message(message.chat.id, f"{reply_to.from_user.username} susturması kaldırıldı.")
            else:
                bot.send_message(message.chat.id, "Lütfen bir mesajı yanıtlayarak /unmutemute komutunu kullanın.")
        else:
            bot.send_message(message.chat.id, "Bu komutu kullanmak için kanal yöneticisi olmanız gerekiyor.")
        ...
        print(f"Kullanıcıyı susturma sırasında hata oluştu: {e}")
        bot.send_message(message.chat.id, f"Kullanıcıyı susturması kaldırılırken bir hata oluştu. Lütfen daha sonra tekrar deneyin.")
